...
As you can see, some stations are much better to be close to. Just to take a clear example, being at the end of the Bay Ridge services (far bottom left in Brooklyn) is much worse than being near Coney Island (far bottom of greyed-out Brooklyn) even though both are terminal stations: the Coney Island station has a visible catchment area starting at 5 minutes whereas teh Bay Ridge one doesn't have one until 15 minutes. Moreover, one can see extremely clearly where's a (subway) transit desert and where it is clearly not -- Manhattan versus eastern Queens is night and day in terms of subway service reliability. 
