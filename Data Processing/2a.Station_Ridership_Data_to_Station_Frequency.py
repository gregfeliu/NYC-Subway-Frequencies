...
try:
    hourly_station_ridership = pd.read_csv(f"{parent_dir}/saved_data/hourly_station_ridership.csv")
    # data comes in as an average for a week over a month so dividing by the number of months to get average per week
    hourly_station_ridership['sum_ridership'] = hourly_station_ridership['sum_ridership'] / 12
...
route_id_ridership_grouped['weekday_ridership_adj'] = (route_id_ridership_grouped['weekday_ridership_adj'] * 52.14 * 12) / 1000000
