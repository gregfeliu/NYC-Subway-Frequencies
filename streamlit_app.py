...
#             **To start, please select how you would like to view the data in the sidebar**""")
    ...
    st.divider()
    st.markdown("""This app uses the [static MTA GTFS Schedule from February 22, 2025 to May 18, 2025](http://web.mta.info/developers/data/nyct/subway/google_transit.zip). 
