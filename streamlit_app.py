...
#             **To start, please select how you would like to view the data in the sidebar**""")
    ...
    st.divider()
    st.markdown("""This app uses the [static MTA GTFS Schedule from May 17th, 2026 to September 7th, 2026](http://web.mta.info/developers/data/nyct/subway/google_transit.zip). 
